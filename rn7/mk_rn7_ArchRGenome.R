...
txdb_sqlite_fn = file.path(GENOMEDIR, 'rn7_liftoff_mm10.sqlite')
if(!file.exists(txdb_sqlite_fn)){
  # load in the gene annotation and save to sqlite 
  txdb = makeTxDbFromGFF(
    file.path(GENOMEDIR,'rn7_liftoff_mm10_RefSeq.gtf'), 
...
txdb_rda = file.path(GENOMEDIR,'rn7_liftoff_mm10._genes_exons_TSS.rda')
...
save(genomeAnnotation, geneAnnotation, file = 
       file.path(GENOMEDIR,'rn7_liftoff_mm10NcbiRefSeq_ArchR_annotations.rda'))
